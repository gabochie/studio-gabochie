...
export async function onRequest(context) {
  ...
  try {
    ...
    var summary = [
      'Studio Gabochie — 12-Month Analytics Summary\n',
    ...
    var systemPrompt = 'You are a predictive analytics AI for Studio Gabochie. Analyze the historical data and provide concise, data-driven insights. Output valid JSON only.';
