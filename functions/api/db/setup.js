...
('Write Systems Thinking module 1: Iceberg Model', 'Deep-dive content with examples, diagrams, and practical exercises', 6, 'done', 'agent', 'high'),
      ...
      `UPDATE programs SET status = 'coming_soon', tagline = 'Building on the Foundation of God&rsquo;s Wisdom', sample_content = '<h2>Coming Soon: Architectural Thinking Program</h2><p>This program is currently in development. We are crafting a complete curriculum on thinking like an architect — from blueprint thinking to strategic frameworks and execution systems.</p><p>In the meantime, explore <a href="/school/">Systems Thinking in Genesis</a> to start your learning journey.</p>', full_content = '<h2>Module 1: Blueprint Thinking</h2><p>Every great building starts with a blueprint. The same is true for your life, your projects, and your purpose. As the Apostle Paul writes, <em>&ldquo;According to the grace of God which was given to me, like a wise master builder I laid a foundation, and another is building on it. But each man must be careful how he builds on it. For no man can lay a foundation other than the one which is laid, which is Jesus Christ&rdquo;</em> (1&nbsp;Corinthians&nbsp;3:10-11).</p><p>Before you build anything &mdash; a business, a career, a family, a ministry &mdash; you must first see it clearly in your mind. This is blueprint thinking: the ability to envision the whole before you touch the parts.</p><h3>The Architectural Question</h3><p>God asked Job: <em>&ldquo;Where were you when I laid the foundation of the earth? Tell Me, if you have understanding&rdquo;</em> (Job&nbsp;38:4). Before every project, ask yourself: <em>What am I actually building?</em></p><ul><li>Define the purpose &mdash; Why does this exist?</li><li>Identify the foundation &mdash; What must be in place for this to stand?</li><li>Sketch the whole &mdash; What does the finished work look like?</li></ul><h3>Blueprint Exercise</h3><p><strong>Read Proverbs 24:3-4.</strong> Solomon tells us that by wisdom a house is built and by understanding it is established. Take one project or goal you are working on. Write a one-paragraph blueprint: What is its purpose? What is its foundation? What does success look like? Be specific. An architect would not build without a plan. Neither should you.</p><hr><h2>Module 2: Design Principles</h2><p>Architecture is not just about making things stand &mdash; it is about making things that work, that last, and that serve people well. Abraham <em>&ldquo;was looking forward to the city which has foundations, whose architect and builder is God&rdquo;</em> (Hebrews&nbsp;11:10). God Himself is the ultimate architect, and His creation reveals timeless design principles.</p><h3>Principle 1: Form Follows Function</h3><p>God created each thing with a purpose. The sun rules the day; the moon governs the night (Genesis&nbsp;1:16-18). In your projects, ask: <em>Does the form serve the function?</em></p><h3>Principle 2: Strength Through Structure</h3><p>Jesus said the wise man built his house on the rock (Matthew&nbsp;7:24-25). The structure &mdash; not just the surface &mdash; determines whether something withstands storms.</p><h3>Principle 3: Beauty is Not Optional</h3><p>Exodus&nbsp;35:30-35 describes Bezalel, whom God filled with wisdom, understanding, and knowledge to create artistic designs. Beauty is not decoration &mdash; it is part of God&rsquo;s design for excellence.</p><h3>Design Exercise</h3><p><strong>Read Luke 14:28-30.</strong> Jesus Himself said that before building a tower, you count the cost. Take a project you are working on. List three design principles you will follow and explain why each one matters for the people you serve.</p><hr><h2>Module 3: Strategic Frameworks</h2><p>Strategy is the art of connecting your blueprint to reality. It is not enough to have a vision &mdash; you must have a path to get there. <em>&ldquo;The plans of the diligent lead surely to advantage, but everyone who is hasty comes surely to poverty&rdquo;</em> (Proverbs&nbsp;21:5).</p><h3>Framework 1: The OSWALD Cycle</h3><p>Based on the biblical pattern of Observe, Seek, Wait, Act, Learn, Deliver:</p><ul><li><strong>Observe</strong> &mdash; <em>&ldquo;The prudent sees the evil and hides himself&rdquo;</em> (Proverbs&nbsp;22:3). Assess your situation honestly.</li><li><strong>Seek</strong> &mdash; <em>&ldquo;If any of you lacks wisdom, let him ask of God&rdquo;</em> (James&nbsp;1:5). Seek counsel from God and wise advisors.</li><li><strong>Wait</strong> &mdash; <em>&ldquo;Those who wait for the Lord will gain new strength&rdquo;</em> (Isaiah&nbsp;40:31). Timing is part of strategy.</li><li><strong>Act</strong> &mdash; <em>&ldquo;Faith without works is dead&rdquo;</em> (James&nbsp;2:26). Execute with courage.</li><li><strong>Learn</strong> &mdash; <em>&ldquo;Examine yourselves to see whether you are in the faith&rdquo;</em> (2&nbsp;Corinthians&nbsp;13:5). Review and reflect.</li><li><strong>Deliver</strong> &mdash; <em>&ldquo;Whatever you do, do your work heartily, as for the Lord&rdquo;</em> (Colossians&nbsp;3:23). Bring it to completion.</li></ul><h3>Framework 2: The Pillars of Sustainable Design</h3><p>Every lasting creation rests on four pillars:</p><ul><li><strong>Structural Integrity</strong> &mdash; Is the foundation sound?</li><li><strong>Operational Efficiency</strong> &mdash; Does it work without waste?</li><li><strong>Adaptive Resilience</strong> &mdash; Can it withstand change?</li><li><strong>Human Purpose</strong> &mdash; Whom does it serve?</li></ul><h3>Strategy Exercise</h3><p><strong>Read Proverbs 24:3-6.</strong> Write down a current challenge you face. Walk it through the OSWALD Cycle &mdash; one sentence per step. Then identify which of the four pillars is weakest in your current approach. Write one action you will take to strengthen it.</p><hr><h2>Module 4: Execution &amp; Systems</h2><p>A blueprint without execution is just a wish. Architecture becomes reality only when materials are assembled, workers are coordinated, and the building rises from the ground. As James writes, <em>&ldquo;Be doers of the word, and not hearers only, deceiving yourselves&rdquo;</em> (James&nbsp;1:22).</p><h3>The Execution Mindset</h3><p>Joseph did not just interpret Pharaoh&rsquo;s dream &mdash; he built a seven-year storage system that saved Egypt and the surrounding nations (Genesis&nbsp;41). He moved from blueprint to execution with precision and diligence.</p><h3>Four Keys to Execution</h3><ol><li><strong>Break It Down</strong> &mdash; Large visions become achievable through small, concrete steps. Proverbs&nbsp;14:1: <em>&ldquo;The wise woman builds her house.&rdquo;</em> One stone at a time.</li><li><strong>Build Feedback Loops</strong> &mdash; Wisdom cries out in the street (Proverbs&nbsp;1:20-21). Create systems that tell you when you are off course. Come, let us reason together, says the Lord (Isaiah&nbsp;1:18).</li><li><strong>Develop Rhythms</strong> &mdash; God created in six days and rested on the seventh (Genesis&nbsp;2:2-3). Work requires rest. Create sustainable rhythms, not burnout cycles.</li><li><strong>Review Relentlessly</strong> &mdash; <em>&ldquo;Let us examine our ways and test them, and let us return to the Lord&rdquo;</em> (Lamentations&nbsp;3:40). Regular review is not optional &mdash; it is how you stay on the foundation.</li></ol><h3>Final Project</h3><p><strong>Read James 1:22-25.</strong> Take the blueprint you wrote in Module 1. Write a one-page execution plan: Break it into phases, define milestones, set review dates (weekly and monthly), and identify who will hold you accountable.</p><p><em>&ldquo;Teach me, O Lord, the way of Your statutes, and I shall observe it to the end&rdquo;</em> (Psalm&nbsp;119:33).</p><p>You are no longer just a builder. You are an architect.</p>' WHERE slug = 'architectural-thinking'`,
      `INSERT OR IGNORE INTO programs (title, slug, tagline, description, duration, price, price_label, status, sample_content, full_content, sort_order) VALUES ('Systems Thinking Program', 'systems-thinking', 'Biblical Wisdom for Seeing the Whole', 'By wisdom a house is built, and through understanding it is established; through knowledge its rooms are filled with rare and beautiful treasures (Proverbs 24:3-4). This program teaches you to see the interconnected systems God has woven into creation � in business, society, and your personal life � so you can design solutions that actually work. For in Him all things hold together (Colossians 1:17).', 'Self-paced', 250, 'Free Sample · Full Access GH¢ 250', 'coming_soon', '<h2>Welcome to the Systems Thinking Program</h2><p>As Solomon wrote, <em>"It is the glory of God to conceal a matter; it is the honor of kings to search it out"</em> (Proverbs 25:2). Systems thinking is the art of searching out the hidden structures that shape our world � structures that reflect the order of the Creator Himself.</p><p>Before we dive into the models, let us start with a simple exercise. Look around you right now. Pick one problem � in your work, your community, or your life � and ask: <em>What keeps this problem in place?</em></p><p>That is the first step. Systems thinking begins not with answers, but with better questions.</p><h3>Your First Tool: The Iceberg Model</h3><p>Most people react to events. Systems thinkers look deeper � because God created the world with depth, not just surface. As the heavens are higher than the earth, so are His ways higher than our ways (Isaiah 55:9).</p><ul><li><strong>Events</strong> � What happened? (the tip)</li><li><strong>Patterns</strong> � What has been happening over time?</li><li><strong>Structure</strong> � What forces are driving these patterns?</li><li><strong>Mental Models</strong> � What beliefs keep this structure in place?</li></ul><p>For the full program, you will get video walkthroughs, real-world case studies, worksheets, and community exercises � all grounded in the truth that all wisdom begins with the fear of the Lord (Proverbs 9:10).</p>', '', 1), ('Architectural Thinking Program', 'architectural-thinking', 'Building on the Foundation of God's Wisdom', 'According to the grace of God given to me, like a skilled master builder I laid a foundation, and someone else is building upon it. Let each one take care how he builds upon it. For no one can lay a foundation other than that which is laid, which is Jesus Christ (1 Corinthians 3:10-11). This program teaches you to think like a master builder — structuring ideas, projects, and systems with the wisdom that comes from above. For Abraham was looking forward to the city whose architect and builder is God (Hebrews 11:10). From blueprints to execution, you will learn to build things that stand the test of time because they are built on the Rock (Matthew 7:24-25).', 'Self-paced', 0, 'Free', 'coming_soon', '<h2>Welcome to the Architectural Thinking Program</h2><p>Architects do not build by accident. Before a single brick is laid, they have a plan — a blueprint that accounts for structure, load, flow, and beauty. But the greatest Architect of all is God Himself. As Scripture declares, <em>"For he was looking forward to the city with foundations, whose architect and builder is God"</em> (Hebrews 11:10).</p><p>Architectural Thinking applies the same discipline God demonstrated in creation to your ideas, projects, and systems. You will learn to think like a master builder: to see the whole before th<h2>Module 1: Blueprint Thinking</h2><p>Every great building starts with a blueprint. Not a sketch. Not a vague idea. A detailed plan that accounts for every beam, every load, every flow of people and energy. Blueprint Thinking applies this same rigor to your ideas and projects.</p><h3>Read 1 Corinthians 3:10-15</h3><p><strong>Key Idea: Lay the Right Foundation</strong></p><p>Paul describes himself as a skilled master builder laying a foundation. He knew that the quality of the foundation determines the quality of everything built on it. The same is true for your projects.</p><h3>The Four Questions of Blueprint Thinking</h3><p>Before any project, ask these four questions — through the lens of Scripture:</p><p><strong>1. What are we building?</strong> — Define the output with clarity. A website? A team? A movement? A product? Be specific. As Jesus said, <em>"Which of you, wanting to build a tower, does not first sit down and count the cost?"</em> (Luke 14:28).</p><p><strong>2. Why does it exist?</strong> — What purpose does it serve? <em>"Whatever you do, do it all for the glory of God"</em> (1 Corinthians 10:31). Purpose is the foundation. Without it, the structure has no reason to stand.</p><p><strong>3. Who is it for?</strong> — Who will use it, live in it, or be affected by it? <em>"Do nothing out of selfish ambition or vain conceit. Rather, in humility value others above yourselves"</em> (Philippians 2:3). Every architectural decision should serve the user.</p><p><strong>4. How will it hold together?</strong> — What is the structural logic? In Christ all things hold together (Colossians 1:17). Your project needs the same coherence — parts that relate to the whole with integrity.</p><h3>Exercise: Your First Blueprint</h3><p>Take a project you are currently working on — or one you have been procrastinating on. Write a one-page blueprint that answers the four questions above. Before you begin, pray and ask God for wisdom, for <em>"the Lord gives wisdom; from His mouth come knowledge and understanding"</em> (Proverbs 2:6). Do not start execution until the blueprint is complete.</p><hr><h2>Module 2: Design Principles</h2><p>Principles are not rules. Rules tell you what to do. Principles tell you how to think. When you have strong principles rooted in Scripture, you do not need rules — because you can reason from first principles in any situation.</p><h3>Read Proverbs 14:1</h3><p><strong>Key Idea: The Wise Woman Builds Her House</strong></p><p>The wisest woman builds her house with wisdom. Folly tears it down with her own hands. Every design decision either builds up or tears down. Principle-driven design ensures you build.</p><h3>Principle 1: Form Follows Function</h3><p>The shape of anything should be determined by its purpose. God designed each part of creation with intentional form for its function — the sun to rule the day, the moon to rule the night (Genesis 1:16). When you force function to follow form, you get style over substance.</p><p>Ask: <em>Does the form of this project serve its function? Or am I choosing form for its own sake?</em></p><h3>Principle 2: Less is More</h3><p>Every addition is a subtraction. When you add a feature, a page, a step, or a rule, you subtract from clarity, speed, and focus. The best designs are not the ones with the most features — they are the ones with the fewest, most essential features executed well. As Scripture says, <em>"Better one handful with tranquility than two handfuls with toil and chasing after the wind"</em> (Ecclesiastes 4:6).</p><h3>Principle 3: Strength Through Structure</h3><p>A building is only as strong as its structure. The same is true for organizations, projects, and systems. Jesus said the wise man built his house on the rock — and when the storms came, it stood firm (Matthew 7:24-25). Invest in the structure — the relationships, the workflows, the feedback loops — and the surface will take care of itself.</p><p>Ask: <em>What is holding this together? Is the structure built on the Rock?</em></p><h3>Principle 4: Design for the Edge Cases</h3><p>The best designs break gracefully. They account for failure, not just success. Joseph did not wait for the famine to store grain — he planned for seven years of abundance to prepare for seven years of scarcity (Genesis 41). When you design for the edge cases — the worst-case scenario, the unexpected user, the system under stress — you create something that works for everyone.</p><h3>Exercise: Audit Your Design Principles</h3><p>Look at a project you have built or are building. Write down the implicit principles that guided your decisions. Then ask: <em>Are these principles rooted in God’s wisdom? What biblical principle, if adopted, would most improve this project?</em></p><hr><h2>Module 3: Strategic Frameworks</h2><p>Frameworks are mental models that help you see patterns, make decisions, and communicate complex ideas simply. They are the tools in the master builder’s belt — and the wisest frameworks come from Scripture.</p><h3>Read Proverbs 1:20-21</h3><p><strong>Key Idea: Wisdom Cries Aloud in the Street</strong></p><p>God’s wisdom is not hidden. It calls out in every situation. Strategic frameworks help you hear it.</p><h3>The OODA Loop</h3><p>Observe, Orient, Decide, Act. This framework for decision-making under uncertainty echoes the biblical pattern: <em>"Come now, let us reason together"</em> (Isaiah 1:18). The key insight: speed matters. The faster you can cycle through OODA, the more adaptive you become.</p><p><strong>Observe</strong> — Gather data from your environment. <em>"The prudent give thought to their steps"</em> (Proverbs 14:15).</p><p><strong>Orient</strong> — Analyze the data through the lens of Scripture and experience. <em>"Test everything; hold fast what is good"</em> (1 Thessalonians 5:21).</p><p><strong>Decide</strong> — Choose a course of action. <em>"Commit your work to the Lord, and your plans will be established"</em> (Proverbs 16:3).</p><p><strong>Act</strong> — Execute your decision. <em>"Be doers of the word, and not hearers only"</em> (James 1:22).</p><h3>First Principles Thinking</h3><p>First principles thinking breaks problems down to their fundamental truths and builds up from there. The ultimate first principle is this: <em>"The fear of the Lord is the beginning of knowledge"</em> (Proverbs 1:7). Every other truth flows from this foundation.</p><p>To use first principles: identify and challenge your assumptions, break the problem down to its basic elements (starting with what God has revealed), and reconstruct a solution from the ground up.</p><h3>The Cynefin Framework</h3><p>Not all problems are the same. Cynefin helps you categorize problems so you can apply the right approach:</p><p><strong>Clear</strong> — Cause and effect are obvious. Apply biblical principles directly. <em>"These are the statutes and rules that you shall be careful to do"</em> (Deuteronomy 4:5-6).</p><p><strong>Complicated</strong> — Cause and effect require analysis. Seek godly counsel. <em>"Where there is no guidance, a people falls, but in an abundance of counselors there is safety"</em> (Proverbs 11:14).</p><p><strong>Complex</strong> — Cause and effect can only be understood in retrospect. Experiment with wisdom. <em>"The heart of the discerning acquires knowledge"</em> (Proverbs 18:15).</p><p><strong>Chaotic</strong> — Act quickly to stabilize, then seek God’s direction. <em>"Be still, and know that I am God"</em> (Psalm 46:10).</p><h3>Exercise: Map a Decision</h3><p>Think of a recent difficult decision you made. Map it through the OODA loop. Where did you spend most of your time? Where did you get stuck? Then classify the problem using Cynefin. Was your approach appropriate for the domain? Finally, ask: <em>Did I seek the Lord’s wisdom first?</em></p><hr><h2>Module 4: Execution and Systems</h2><p>A blueprint without execution is a dream. Execution without a blueprint is chaos. Module 4 brings it all together — turning architectural thinking into action, built on the foundation of Christ.</p><h3>Read James 1:22-25</h3><p><strong>Key Idea: Be Doers of the Word</strong></p><p>Between the blueprint and the building is the execution gap. This is where most projects fail — not because the idea was bad, but because the execution was poor. James warns us: do not merely hear the word — do it.</p><h3>Closing the Execution Gap</h3><p>Three things are required: clarity, commitment, and feedback.</p><p><strong>Clarity</strong> — Everyone involved must know exactly what to do and why. <em>"If the trumpet does not sound a clear call, who will get ready for battle?"</em> (1 Corinthians 14:8). Ambiguity is the enemy of execution.</p><p><strong>Commitment</strong> — Without commitment, the plan is just words. <em>"Whatever your hand finds to do, do it with all your might"</em> (Ecclesiastes 9:10). Commitment means resources allocated, deadlines set, and accountability assigned.</p><p><strong>Feedback</strong> — You cannot execute in the dark. You need systems that tell you whether you are on track. <em>"Plans fail for lack of counsel, but with many advisers they succeed"</em> (Proverbs 15:22). Build in regular review cycles.</p><h3>Building Execution Systems</h3><p>Systems are the difference between a one-time success and sustained achievement. A system is a repeatable process that produces a consistent result. God Himself established systems — the seasons, the priesthood, the feasts — patterns that sustained His people.</p><p>Key elements of an execution system:</p><p><strong>1. Triggers</strong> — What starts the process? A trigger could be a time (every Monday), an event (a new customer signs up), or a condition. <em>"There is a time for everything, and a season for every activity under the heavens"</em> (Ecclesiastes 3:1).</p><p><strong>2. Workflow</strong> — What are the steps? Who does what, in what order, with what tools? <em>"Let all things be done decently and in order"</em> (1 Corinthians 14:40). Document the workflow so it can be repeated and improved.</p><p><strong>3. Feedback Loops</strong> — How do you know it is working? <em>"Iron sharpens iron, and one man sharpens another"</em> (Proverbs 27:17). Build in metrics, checkpoints, and reviews.</p><p><strong>4. Improvement Cycles</strong> — No system is perfect. Build in regular intervals for reflection and refinement. <em>"Let us examine our ways and test them, and let us return to the Lord"</em> (Lamentations 3:40).</p><h3>The Master Builder’s Discipline</h3><p>Architectural Thinking is not a one-time exercise. It is a discipline — a way of approaching every project, every problem, every decision as an act of worship. The master builder does not stop thinking when the blueprint is done. The builder stays with the work, observing, adjusting, and improving — all for the glory of God.</p><p>As you go forward, remember:</p><ul><li>Start with the blueprint, not the bricks — and let Christ be the foundation.</li><li>Let Scripture guide your principles.</li><li>Use frameworks to see clearly — for wisdom cries aloud in the street.</li><li>Build systems that execute for you — and do it all for the glory of God.</li></ul><h3>Final Exercise: Your Architectural Portfolio</h3><p>Go back to the project you blueprinted in Module 1. Apply the design principles from Module 2. Run it through the strategic frameworks from Module 3. Design an execution system using Module 4. Before you begin each step, pray: <em>"Teach me, Lord, the way of Your decrees, that I may follow it to the end"</em> (Psalm 119:33).</p><p>You are no longer just a builder. You are a master builder — building on the foundation of Jesus Christ.</p>mber:</p><ul><li>Start with the blueprint, not the bricks.</li><li>Let principles guide your decisions.</li><li>Use frameworks to see clearly.</li><li>Build systems that execute for you.</li></ul><h3>Final Exercise: Your Architectural Portfolio</h3><p>Go back to the project you blueprinted in Module 1. Apply the design principles from Module 2. Run it through the strategic frameworks from Module 3. Design an execution system using Module 4. You now have a complete architectural plan - from blueprint to execution.</p><p>You are no longer just a builder. You are an architect.</p>', 2)`
    ];
    const results = [];
