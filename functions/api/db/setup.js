...
('Write Systems Thinking module 1: Iceberg Model', 'Deep-dive content with examples, diagrams, and practical exercises', 6, 'done', 'agent', 'high'),
      ...
      `INSERT OR IGNORE INTO programs (title, slug, tagline, description, duration, price, price_label, status, sample_content, sort_order) VALUES
        ('Systems Thinking in Genesis', 'systems-thinking-genesis', 'Biblical Foundations of Systems Thinking', 'Explore the book of Genesis through a systems thinking lens. See creation, the fall, the patriarchs, and the exodus as interconnected systems with feedback loops, leverage points, and emergent properties.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Systems Thinking in Genesis</h2><p>The Bible is not just a collection of stories - it is a living system. In this program, we examine Genesis through the lens of systems thinking.</p>', 3),
        ('Introduction to Design Thinking', 'intro-design-thinking', 'A Human-Centered Approach to Problem Solving', 'Learn the fundamentals of design thinking: empathize, define, ideate, prototype, and test. A practical framework for creative problem solving that puts people first.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Design Thinking</h2><p>Design thinking is a human-centered approach to innovation. This program introduces the core principles and practices.</p>', 4),
        ('Design Thinking in Genesis \u2013 The Creation', 'design-thinking-genesis', 'The Original Design Blueprint', 'Discover how the Genesis creation account reveals the ultimate design thinking process. From the separation of light and darkness to the creation of humanity, every step follows a divine design methodology.', 'Self-paced', 0, 'Free', 'active', '<h2>Design Thinking in Genesis</h2><p>The creation account in Genesis is the original design thinking case study.</p>', 5),
        ('Introduction to Biomimicry', 'intro-biomimicry', 'Learning from Nature''s Genius', 'Nature has been solving problems for 3.8 billion years. Biomimicry is the practice of learning from nature''s patterns and strategies to create sustainable human solutions.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Biomimicry</h2><p>Nature is the world''s greatest engineer. This program introduces the principles of biomimicry.</p>', 6),
        ('Introduction to Geometry', 'intro-geometry', 'The Dot, Dots, Lines, Angles, Shapes, Planes and Forms', 'A foundational journey through geometry - from the simplest dot to complex planes and forms. Understand the language of shape, space, and structure that underlies all creation.', 'Self-paced', 0, 'Free', 'active', '<h2>Introduction to Geometry</h2><p>Geometry is the language of creation. From the smallest dot to the grandest cathedral, every form can be understood through geometric principles.</p>', 7),
        ('Introduction to The Computer & Computing', 'intro-computing', 'Understanding the Digital Revolution', 'What is a computer? How does it think? This program takes you from the fundamentals of computing hardware and software to how computers process, store, and communicate information.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Computing</h2><p>Computers shape every aspect of modern life. This program demystifies how they work.</p>', 8),
        ('Introduction to Storytelling & Narrative Design', 'intro-storytelling', 'The Art of Shaping Meaning', 'Storytelling is the bridge between knowledge and impact. This program teaches narrative structure, character arcs, metaphor, and oral tradition — from biblical foundations to modern media. Learn to craft stories that inform, inspire, and transform.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Storytelling & Narrative Design</h2><p>Every great teacher, prophet, and leader knew one thing: truth lands better in a story. This program explores the craft of narrative.</p>', 9)
      `,
      // Module seeds for new programs
      `INSERT OR IGNORE INTO modules (program_id, title, slug, description, sort_order) VALUES
        ((SELECT id FROM programs WHERE slug = 'systems-thinking-genesis'), 'Module 1: Creation as a System', 'genesis-creation-system', 'How the six days of creation form an interconnected system.', 1),
        ((SELECT id FROM programs WHERE slug = 'systems-thinking-genesis'), 'Module 2: Patterns in the Patriarchs', 'genesis-patriarchs', 'Recurring patterns and cycles in the lives of Abraham, Isaac, and Jacob.', 2),
        ((SELECT id FROM programs WHERE slug = 'systems-thinking-genesis'), 'Module 3: Joseph''s Economic System', 'genesis-joseph', 'Joseph''s governance of Egypt as a case study in systems design.', 3),
        ((SELECT id FROM programs WHERE slug = 'systems-thinking-genesis'), 'Module 4: The Exodus as a Feedback Loop', 'genesis-exodus', 'The Exodus as a reinforcing feedback loop of liberation and covenant.', 4),
