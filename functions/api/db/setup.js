...
('Write Systems Thinking module 1: Iceberg Model', 'Deep-dive content with examples, diagrams, and practical exercises', 6, 'done', 'agent', 'high'),
      ...
      `INSERT OR IGNORE INTO programs (title, slug, tagline, description, duration, price, price_label, status, sample_content, full_content, sort_order) VALUES
        ('Systems Thinking in Genesis', 'systems-thinking-genesis', 'Biblical Foundations of Systems Thinking', 'Explore the book of Genesis through a systems thinking lens. See creation, the fall, the patriarchs, and the exodus as interconnected systems with feedback loops, leverage points, and emergent properties.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Systems Thinking in Genesis</h2><p>The Bible is not just a collection of stories — it is a living system. In this program, we examine Genesis through the lens of systems thinking.</p>', '<h2>Full Curriculum: Systems Thinking in Genesis</h2><p>This course explores the book of Genesis as a case study in systems thinking. Each module reveals a different systems concept through the biblical narrative, from creation to the exodus.</p><h3>Module 1: Creation as a System</h3><p>The six days of creation are not just a timeline — they are an interconnected system where each day builds on the previous one. We examine the interdependence of light, sky, land, plants, celestial bodies, sea creatures, birds, land animals, and humanity as a nested hierarchy of systems.</p><h3>Module 2: Patterns in the Patriarchs</h3><p>The lives of Abraham, Isaac, and Jacob reveal recurring patterns and cycles that systems thinking helps us identify. From covenant promises to family dynamics, we trace the reinforcing and balancing feedback loops that shape biblical history.</p><h3>Module 3: Joseph''s Economic System</h3><p>Joseph''s governance of Egypt during seven years of abundance followed by seven years of famine is a masterclass in systems design — inventory management, resource allocation, and anticipatory governance.</p><h3>Module 4: The Exodus as a Feedback Loop</h3><p>The Exodus story is a reinforcing feedback loop of liberation: cry out → God hears → deliverance → covenant → worship. Each cycle builds on the last, creating an emergent movement of a liberated people.</p>', 3),
