...
('Systems Thinking for Vision Builders', 'systems-thinking', 'See the whole. Solve the root. Design the future.', 'Understand the hidden patterns that shape our world. This program teaches you to see interconnected systems, anticipate ripple effects, and design solutions that actually work — whether in business, society, or your personal life. Through case studies, mental models, and practical exercises, you''ll develop the lens of a systems thinker.', 'Self-paced', 250, 'Free Sample · Full Access GH¢ 250', 'active', '<h2>Welcome to Systems Thinking for Vision Builders</h2><p>Before we dive into the models, let''s start with a simple exercise. Look around you right now. Pick one problem — in your work, your community, or your life — and ask: <em>What keeps this problem in place?</em></p><p>That''s the first step. Systems thinking begins not with answers, but with better questions.</p><h3>Your First Tool: The Iceberg Model</h3><p>Most people react to events. Systems thinkers look deeper:</p><ul><li><strong>Events</strong> — What happened? (the tip)</li><li><strong>Patterns</strong> — What''s been happening over time?</li><li><strong>Structure</strong> — What forces are driving these patterns?</li><li><strong>Mental Models</strong> — What beliefs keep this structure in place?</li></ul><p>For the full program, you''ll get video walkthroughs, real-world case studies, worksheets, and community exercises.</p>', 1),
('Architectural Thinking for Vision Builders', 'architectural-thinking', 'Build on the foundation of God&rsquo;s wisdom', 'By wisdom a house is built, and through understanding it is established (Proverbs 24:3-4). This program teaches you to think like an architect — structuring ideas, projects, and systems with clarity, purpose, and biblical wisdom. From blueprint thinking to design principles, strategic frameworks, and execution systems, you will learn to design solutions that stand the test of time because they are built on the foundation of God&rsquo;s truth.', 'Self-paced', 0, 'Free', 'active', '<h2>Welcome to Architectural Thinking for Vision Builders</h2><p>Every great building starts with a blueprint. The same is true for your life, your projects, and your purpose. As the Apostle Paul writes, <em>&ldquo;According to the grace of God which was given to me, like a wise master builder I laid a foundation, and another is building on it. But each man must be careful how he builds on it.&rdquo;</em></p><p>This program takes you from blueprint thinking through design principles, strategic frameworks, and execution systems — so you can build anything that matters with clarity and confidence.</p>', 4);
