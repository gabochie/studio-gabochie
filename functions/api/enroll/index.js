  ...
  try {
    ...
    if (env.BREVO_API_KEY) {
      try {
        ...
        await fetch('https://api.brevo.com/v3/smtp/email', {
          ...
          body: JSON.stringify({
            ...
            subject: 'Welcome to ' + program.title + ' — Studio by Gabochie',
      ...
      try {
        ...
        await queueEmail(env, studentEmail, studentName, 'Getting Started with ' + program.title + ' — Studio by Gabochie', followupHtml, 'enrollment_followup', daysFromNow(3));
      } catch (_e) {}
    }
