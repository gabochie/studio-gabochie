    ...
    if (env.BREVO_API_KEY && email) {
      try {
        const emailHtml = '<!DOCTYPE html><html><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#F4F6FA;font-family:Georgia,serif">' +
          ...
          '<p style="color:#94A3B8;font-size:11px;line-height:1.5;margin:0">Studio Gabochie &mdash; Accra, Ghana</p>' +
        ...
        await fetch('https://api.brevo.com/v3/smtp/email', {
          ...
          body: JSON.stringify({
            ...
            subject: 'Welcome to the Nationbuilding Program — Studio Gabochie',
