...
export async function onRequest(context) {
  ...
  try {
    ...
    var pageTitle = esc(campaign.name) + ' — Studio by Gabochie Fundraising';
    ...
    html += '<div class="share-row">' +
      '<a href="https://twitter.com/intent/tweet?text=' + encodeURIComponent('Support ' + campaign.name + ' — Studio by Gabochie') + '&url=' + encodeURIComponent(pageUrl) + '" target="_blank" rel="noopener"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>Tweet</a>' +
      ...
      'customizations:{title:"Studio by Gabochie",description:"Support: "+CAMPAIGN_SLUG,logo:window.location.origin+"/assets/images/logo.png"},' +
    ...
    var errHtml = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Error — Studio by Gabochie</title><style>body{font-family:Inter,sans-serif;background:#0A1628;color:#CDD5E0;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;padding:24px;text-align:center}.card{background:#0F1F35;border:1px solid #1E3456;border-radius:12px;padding:48px;max-width:400px}h1{font-family:Barlow Condensed,sans-serif;color:#fff;margin:0 0 8px}p{color:#6B7F9A;margin:0 0 24px}a{color:#C9A84C;text-decoration:none}</style></head><body><div class="card"><h1>Something Went Wrong</h1><p>Please try again later.</p><a href="/campaigns/">&larr; View All Campaigns</a></div></body></html>';
